...
#
# Generated by Vivado on Sat Sep 24 17:06:10 +0530 2022
...
# Script info
echo -e "FIFO.sh - Script generated by export_simulation (Vivado v2018.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L fifo_generator_v13_2_2 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot FIFO xil_defaultlib.FIFO xil_defaultlib.glbl -log elaborate.log
}
